  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--ink)", color: "var(--text)" }}>
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "40px 20px 80px" }}>
        ...
        <h1 style={{ fontFamily: "Syne", fontSize: 28, fontWeight: 800, margin: "16px 0 4px" }}>{doc.title}</h1>
        ...
        {doc.sections.map(([heading, body]) => (
          <div key={heading} style={{ marginBottom: 22 }}>
            <h2 style={{ fontFamily: "Syne", fontSize: 15, fontWeight: 700, marginBottom: 6 }}>{heading}</h2>
