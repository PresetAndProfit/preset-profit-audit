    ...
    <style>{`
      ...
      *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
      ...
      .assumptions-slider::-webkit-slider-thumb{
        ...
        box-shadow:0 0 0 2px var(--amber),0 2px 8px rgba(245,166,35,0.5);
        transition:box-shadow .15s,transform .1s;
      }
      .assumptions-slider::-webkit-slider-thumb:hover{
        box-shadow:0 0 0 4px rgba(245,166,35,0.25),0 2px 12px rgba(245,166,35,0.6);
      ...
      .assumptions-slider:focus::-webkit-slider-thumb{
        box-shadow:0 0 0 5px rgba(245,166,35,0.3),0 2px 12px rgba(245,166,35,0.5);
      }
    `}</style>
  );
}
